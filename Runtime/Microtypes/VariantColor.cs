...
namespace UIToolkitCodex.Microtypes
{
    public readonly struct VariantColor
    {
        ...
        public VariantColor(Color s50, Color s100, Color s200, Color s300, Color s400, Color s500, Color s600,
            Color s700, Color s800, Color s900, Color s950)
        {
            this.s50 = s50;
            this.s100 = s100;
            this.s200 = s200;
        ...
        {
            this.s50 = s50;
            s100 = Color.Lerp(s50, s500, 0.2f);
            s200 = Color.Lerp(s50, s500, 0.4f);
            s300 = Color.Lerp(s50, s500, 0.6f);
            s400 = Color.Lerp(s50, s500, 0.8f);
            this.s500 = s500;
            s600 = Color.Lerp(s500, s950, 0.2f);
            s700 = Color.Lerp(s500, s950, 0.4f);
            s800 = Color.Lerp(s500, s950, 0.6f);
            s900 = Color.Lerp(s500, s950, 0.8f);
            this.s950 = s950;
        }

        public VariantColor Invert()
        {
            return new VariantColor(s950, s900, s800, s700, s600, s500, s400, s300, s200, s100, s50);
        }
    }
}